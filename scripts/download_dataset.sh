...
if [ ! -f $FB_DATASET ]; then
    ...
    wget -O $FB_DATASET "https://www.dropbox.com/scl/fi/hngvfbz1a2tkwpebjngb9/fb_100M_public_uint64?rlkey=px31l6wj9tnic4z604bt6s55n&st=d3iuhhgx&dl=1"
...
if [ ! -f $BOOKS_DATASET ]; then
    ...
    wget -O $BOOKS_DATASET "https://www.dropbox.com/scl/fi/q9zg3shi16xduo7mis3t8/books_100M_public_uint64?rlkey=f6bhaibqsugmo2yo2l4ir3v2r&st=tin2fnoj&dl=1"
    echo "Download complete!"
else
...
if [ ! -f $OSMC_DATASET ]; then
    ...
    wget -O $OSMC_DATASET "https://www.dropbox.com/scl/fi/mamy2obtasfm898l0lrj1/osmc_100M_public_uint64?rlkey=vlzl311wa1q0cwsnc0nfow1qc&st=b30vck9r&dl=1"
    echo "Download complete!"
else
